...
export const ProjectsList: ProjectsListType = [
    ...
    },
    {
        ...
        ShortDesc: "Collection of Python solutions to +380 LeetCode problems.",
        Desc: "A curated collection of Python solutions to +380 LeetCode problems, covering arrays, hashing, sliding window, two pointers, binary search, and more. Each file includes the problem statement, difficulty level, and a clean, well-commented solution.",
        Logo: PythonImage,
        Shot: PythonImage,
        Mockup: PythonImage,
        Theme: "#3776AB",
